...
127 tests automatisés, rejoués par GitHub Actions à chaque push :

- **frontend** — 86 tests (Jest + Testing Library), ESLint, vérification des
  types et bundle Metro.
- **backend** — 41 tests (pytest), base MongoDB simulée en mémoire, Stripe doublé.
