...
async def create_payment_intent(
    ...
    try:
        # Le SDK Stripe est synchrone : exécuté tel quel dans une coroutine, il
        # bloquerait la boucle d'évènements pendant tout l'aller-retour réseau et
        # gèlerait les autres requêtes.
